...
*Solution.* Since exponentiation and log are inverse operations, $e^{\log(7)} = 7$. In general, $e^{\log(x)} = x$.
...
*Solution.* Take natural logs to obtain $x = \log(7)$. Using R, $\log(7) \approx 1.9459$.
...
*Solution.* Add $2y_2$ to both sides to obtain $y_1 = 4 + 2y_2$.
